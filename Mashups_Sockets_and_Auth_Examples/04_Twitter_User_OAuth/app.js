...
var TWITTER_CONSUMER_KEY = 'ECHEmiEPhFZxtFYjeVOVe7nkp';
var TWITTER_CONSUMER_SECRET = 'qCPYDoxWUIRCHTwrcpIZGx6eQ0MhvDQ678KWiVhHZgDwLgHfyX';
...
app.get("/success", checkAuthentication, function(req, res){
	...
	var tweetURL = "https://api.twitter.com/1.1/statuses/user_timeline.json?user_id=" + 1337785291 + "&count=1";
	Request.get(
		{
			url: tweetURL,
			oauth: oAuthData,
